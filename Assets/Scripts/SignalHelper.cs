...
public class SignalHelper : MonoBehaviour 
{
    ...
    public static (double, double, double, double[], int) SelectHighestConfidenceSignal(double[][] signals, double minBeatsPerMin, double maxBeatsPerMin)
    {
        ...
        double[] bestSignalFft = new double[0];
    ...
    //
    // Accepts accelerometer and gyroscope samples and returns the following values:
    ...
    public static (double, double, double) FindRate(List<UnityEngine.Vector3> accel, List<UnityEngine.Vector3> gyro, double minBeatsPerMin, double maxBeatsPerMin, double[] filter)
    {
        /////////////////////////
        //// INITIALIZATION  ////
        /////////////////////////
        ...
        return (60 * frequency, strength, kurtosis);
    }
}
